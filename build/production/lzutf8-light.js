...
*/
var LZUTF8_LIGHT;
(function (LZUTF8_LIGHT) {
    LZUTF8_LIGHT.runningInNodeJS = function () {
        return ((typeof process === "object") && (typeof process.versions === "object") && (typeof process.versions.node === "string"));
    };
    LZUTF8_LIGHT.runningInMainNodeJSModule = function () {
        return LZUTF8_LIGHT.runningInNodeJS() && require.main === module;
    };
    LZUTF8_LIGHT.commonJSAvailable = function () {
        return typeof module === "object" && typeof module.exports === "object";
    };
    LZUTF8_LIGHT.runningInWebWorker = function () {
        return typeof window === "undefined" && typeof self === "object" && typeof self.addEventListener === "function" && typeof self.close === "function";
    };
    LZUTF8_LIGHT.runningInNodeChildProcess = function () {
        return LZUTF8_LIGHT.runningInNodeJS() && typeof process.send === "function";
    };
    LZUTF8_LIGHT.runningInNullOrigin = function () {
    ...
    LZUTF8_LIGHT.webWorkersAvailable = function () {
        if (typeof Worker !== "function" || LZUTF8_LIGHT.runningInNullOrigin())
            return false;
        if (LZUTF8_LIGHT.runningInNodeJS())
            return false;
        if (navigator && navigator.userAgent && navigator.userAgent.indexOf("Android 4.3") >= 0)
            return false;
        return true;
    };
    LZUTF8_LIGHT.log = function (message, appendToDocument) {
    ...
    LZUTF8_LIGHT.createErrorMessage = function (exception, title) {
    ...
    LZUTF8_LIGHT.printExceptionAndStackTraceToConsole = function (exception, title) {
        if (title === void 0) { title = "Unhandled exception"; }
        LZUTF8_LIGHT.log(LZUTF8_LIGHT.createErrorMessage(exception, title));
    };
    LZUTF8_LIGHT.getGlobalObject = function () {
    ...
    LZUTF8_LIGHT.toString = Object.prototype.toString;
    if (LZUTF8_LIGHT.commonJSAvailable())
        module.exports = LZUTF8_LIGHT;
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
...
(function (LZUTF8_LIGHT) {
    ...
    LZUTF8_LIGHT.ArraySegment = ArraySegment;
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
var LZUTF8_LIGHT;
(function (LZUTF8_LIGHT) {
    var ArrayTools;
    ...
    })(ArrayTools = LZUTF8_LIGHT.ArrayTools || (LZUTF8_LIGHT.ArrayTools = {}));
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
var LZUTF8_LIGHT;
(function (LZUTF8_LIGHT) {
    var BufferTools;
    ...
    })(BufferTools = LZUTF8_LIGHT.BufferTools || (LZUTF8_LIGHT.BufferTools = {}));
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
var LZUTF8_LIGHT;
(function (LZUTF8_LIGHT) {
    ...
    (function (CompressionCommon) {
        ...
        CompressionCommon.getCroppedAndAppendedByteArray = function (bytes, cropStartOffset, cropLength, byteArrayToAppend) {
            return LZUTF8_LIGHT.ArrayTools.concatUint8Arrays([bytes.subarray(cropStartOffset, cropStartOffset + cropLength), byteArrayToAppend]);
        };
        ...
        CompressionCommon.encodeCompressedBytes = function (compressedBytes, outputEncoding) {
            switch (outputEncoding) {
                ...
                case "Buffer":
                    return LZUTF8_LIGHT.BufferTools.uint8ArrayToBuffer(compressedBytes);
                case "Base64":
                    return LZUTF8_LIGHT.encodeBase64(compressedBytes);
                case "BinaryString":
                    return LZUTF8_LIGHT.encodeBinaryString(compressedBytes);
                case "StorageBinaryString":
                    return LZUTF8_LIGHT.encodeStorageBinaryString(compressedBytes);
                default:
        ...
        CompressionCommon.decodeCompressedBytes = function (compressedData, inputEncoding) {
            ...
            switch (inputEncoding) {
                case "ByteArray":
                case "Buffer":
                    var normalizedBytes = LZUTF8_LIGHT.BufferTools.convertToUint8ArrayIfNeeded(compressedData);
        ...
        CompressionCommon.encodeDecompressedBytes = function (decompressedBytes, outputEncoding) {
            switch (outputEncoding) {
                case "String":
                    return LZUTF8_LIGHT.decodeUTF8(decompressedBytes);
                case "ByteArray":
                ...
                case "Buffer":
                    ...
                    return LZUTF8_LIGHT.BufferTools.uint8ArrayToBuffer(decompressedBytes);
                default:
                    throw new TypeError("encodeDecompressedBytes: invalid output encoding requested");
            }
        };
    })(CompressionCommon = LZUTF8_LIGHT.CompressionCommon || (LZUTF8_LIGHT.CompressionCommon = {}));
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
var LZUTF8_LIGHT;
(function (LZUTF8_LIGHT) {
    var EventLoop;
    (function (EventLoop) {
        ...
        EventLoop.initializeScheduler = function () {
            var flush = function () {
                for (var _i = 0, queuedFunctions_1 = queuedFunctions; _i < queuedFunctions_1.length; _i++) {
                    ...
                    try {
                        ...
                        LZUTF8_LIGHT.printExceptionAndStackTraceToConsole(exception, "enqueueImmediate exception");
                    }
                }
            ...
            if (typeof window === "object" && typeof window.addEventListener === "function" && typeof window.postMessage === "function") {
                ...
                var targetOrigin_1;
                if (LZUTF8_LIGHT.runningInNullOrigin())
                    targetOrigin_1 = '*';
                else
    ...
    })(EventLoop = LZUTF8_LIGHT.EventLoop || (LZUTF8_LIGHT.EventLoop = {}));
    LZUTF8_LIGHT.enqueueImmediate = function (func) { return EventLoop.enqueueImmediate(func); };
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
var LZUTF8_LIGHT;
(function (LZUTF8_LIGHT) {
    var ObjectTools;
    ...
    })(ObjectTools = LZUTF8_LIGHT.ObjectTools || (LZUTF8_LIGHT.ObjectTools = {}));
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
var LZUTF8_LIGHT;
(function (LZUTF8_LIGHT) {
    LZUTF8_LIGHT.getRandomIntegerInRange = function (low, high) {
        return low + Math.floor(Math.random() * (high - low));
    };
    LZUTF8_LIGHT.getRandomUTF16StringOfLength = function (length) {
        var randomString = "";
        for (var i = 0; i < length; i++) {
            var randomCodePoint = void 0;
            do {
                randomCodePoint = LZUTF8_LIGHT.getRandomIntegerInRange(0, 0x10FFFF + 1);
            } while (randomCodePoint >= 0xD800 && randomCodePoint <= 0xDFFF);
            randomString += LZUTF8_LIGHT.Encoding.CodePoint.decodeToString(randomCodePoint);
        }
        return randomString;
    };
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
...
(function (LZUTF8_LIGHT) {
    ...
    LZUTF8_LIGHT.StringBuilder = StringBuilder;
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
var LZUTF8_LIGHT;
(function (LZUTF8_LIGHT) {
    var Timer = (function () {
        ...
        Timer.prototype.logAndRestart = function (title, logToDocument) {
            ...
            LZUTF8_LIGHT.log(message, logToDocument);
            this.restart();
            return elapsedTime;
        };
...
(function (LZUTF8_LIGHT) {
    var Compressor = (function () {
        function Compressor(useCustomHashTable) {
            ...
            if (useCustomHashTable && typeof Uint32Array == "function")
                this.prefixHashTable = new LZUTF8_LIGHT.CompressorCustomHashTable(this.PrefixHashTableSize);
            else
                this.prefixHashTable = new LZUTF8_LIGHT.CompressorSimpleHashTable(this.PrefixHashTableSize);
        }
        Compressor.prototype.compressBlock = function (input) {
            if (input === undefined || input === null)
                throw new TypeError("compressBlock: undefined or null input received");
            if (typeof input == "string")
                input = LZUTF8_LIGHT.encodeUTF8(input);
            input = LZUTF8_LIGHT.BufferTools.convertToUint8ArrayIfNeeded(input);
        ...
        Compressor.prototype.cropAndAddNewBytesToInputBuffer = function (newInput) {
            if (this.inputBuffer === undefined) {
                ...
                this.inputBuffer = LZUTF8_LIGHT.CompressionCommon.getCroppedAndAppendedByteArray(this.inputBuffer, cropStartOffset, cropLength, newInput);
    ...
    LZUTF8_LIGHT.Compressor = Compressor;
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
var LZUTF8_LIGHT;
(function (LZUTF8_LIGHT) {
    var CompressorCustomHashTable = (function () {
        ...
        CompressorCustomHashTable.prototype.addValueToBucket = function (bucketIndex, valueToAdd) {
            ...
            if (startPosition === 0) {
                ...
                if (this.storage[endPosition] === 0) {
                    ...
                    LZUTF8_LIGHT.ArrayTools.copyElements(this.storage, startPosition, this.storage, this.storageIndex, length);
                    startPosition = this.storageIndex;
                    this.storageIndex += length;
                    this.storage[this.storageIndex++] = valueToAdd;
                    this.storageIndex += length;
        ...
        CompressorCustomHashTable.prototype.truncateBucketToNewerElements = function (startPosition, bucketLength, truncatedBucketLength) {
            ...
            LZUTF8_LIGHT.ArrayTools.copyElements(this.storage, sourcePosition, this.storage, startPosition, truncatedBucketLength);
            LZUTF8_LIGHT.ArrayTools.zeroElements(this.storage, startPosition + truncatedBucketLength, bucketLength - truncatedBucketLength);
        ...
        CompressorCustomHashTable.prototype.compact = function () {
            ...
            for (var bucketIndex = 0; bucketIndex < oldBucketLocators.length; bucketIndex += 2) {
                ...
                LZUTF8_LIGHT.ArrayTools.copyElements(oldStorage, sourcePosition, this.storage, destPosition, length_4);
            }
        };
        CompressorCustomHashTable.prototype.getArraySegmentForBucketIndex = function (bucketIndex, outputObject) {
            ...
            if (outputObject === undefined)
                outputObject = new LZUTF8_LIGHT.ArraySegment(this.storage, startPosition, this.bucketLocators[bucketIndex + 1]);
            return outputObject;
        };
        CompressorCustomHashTable.prototype.getUsedBucketCount = function () {
            return Math.floor(LZUTF8_LIGHT.ArrayTools.countNonzeroValuesInArray(this.bucketLocators) / 2);
        };
    ...
    LZUTF8_LIGHT.CompressorCustomHashTable = CompressorCustomHashTable;
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
var LZUTF8_LIGHT;
(function (LZUTF8_LIGHT) {
    var CompressorSimpleHashTable = (function () {
        ...
        CompressorSimpleHashTable.prototype.addValueToBucket = function (bucketIndex, valueToAdd) {
            ...
            if (bucket === undefined) {
                ...
                if (bucket.length === this.maximumBucketCapacity - 1)
                    LZUTF8_LIGHT.ArrayTools.truncateStartingElements(bucket, this.maximumBucketCapacity / 2);
        ...
        CompressorSimpleHashTable.prototype.getArraySegmentForBucketIndex = function (bucketIndex, outputObject) {
            ...
            if (bucket === undefined)
                return null;
            if (outputObject === undefined)
                outputObject = new LZUTF8_LIGHT.ArraySegment(bucket, 0, bucket.length);
            return outputObject;
        };
        CompressorSimpleHashTable.prototype.getUsedBucketCount = function () {
            return LZUTF8_LIGHT.ArrayTools.countNonzeroValuesInArray(this.buckets);
        };
    ...
    LZUTF8_LIGHT.CompressorSimpleHashTable = CompressorSimpleHashTable;
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
var LZUTF8_LIGHT;
(function (LZUTF8_LIGHT) {
    var Decompressor = (function () {
        ...
        Decompressor.prototype.decompressBlockToString = function (input) {
            input = LZUTF8_LIGHT.BufferTools.convertToUint8ArrayIfNeeded(input);
            return LZUTF8_LIGHT.decodeUTF8(this.decompressBlock(input));
        };
        Decompressor.prototype.decompressBlock = function (input) {
            if (this.inputBufferRemainder) {
                input = LZUTF8_LIGHT.ArrayTools.concatUint8Arrays([this.inputBufferRemainder, input]);
            ...
            return LZUTF8_LIGHT.CompressionCommon.getCroppedBuffer(this.outputBuffer, outputStartPosition, this.outputPosition - outputStartPosition);
        };
        Decompressor.prototype.outputByte = function (value) {
            if (this.outputPosition === this.outputBuffer.length)
                this.outputBuffer = LZUTF8_LIGHT.ArrayTools.doubleByteArrayCapacity(this.outputBuffer);
        ...
        Decompressor.prototype.cropOutputBufferToWindowAndInitialize = function (initialCapacity) {
            ...
            this.outputBuffer = LZUTF8_LIGHT.CompressionCommon.getCroppedBuffer(this.outputBuffer, this.outputPosition - cropLength, cropLength, initialCapacity);
    ...
    LZUTF8_LIGHT.Decompressor = Decompressor;
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
var LZUTF8_LIGHT;
(function (LZUTF8_LIGHT) {
    var Encoding;
        ...
        (function (Base64) {
            ...
            Base64.encode = function (inputBytes) {
                if (!inputBytes || inputBytes.length == 0)
                    return "";
                if (LZUTF8_LIGHT.runningInNodeJS()) {
                    return (LZUTF8_LIGHT.BufferTools.uint8ArrayToBuffer(inputBytes)).toString("base64");
                }
                else {
            ...
            Base64.decode = function (base64String) {
                if (!base64String)
                    return new Uint8Array(0);
                if (LZUTF8_LIGHT.runningInNodeJS()) {
                    return LZUTF8_LIGHT.BufferTools.bufferToUint8Array(Buffer.from(base64String, "base64"));
                }
                else {
            ...
            Base64.encodeWithJS = function (inputBytes, addPadding) {
                ...
                if (!inputBytes || inputBytes.length == 0)
                    return "";
                var map = charCodeMap;
                var output = new LZUTF8_LIGHT.StringBuilder();
                var uint24;
    ...
    })(Encoding = LZUTF8_LIGHT.Encoding || (LZUTF8_LIGHT.Encoding = {}));
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
var LZUTF8_LIGHT;
(function (LZUTF8_LIGHT) {
    var Encoding;
    (function (Encoding) {
        ...
        (function (BinaryString) {
            BinaryString.encode = function (input) {
                ...
                var outputStringBuilder = new LZUTF8_LIGHT.StringBuilder();
                var remainder = 0;
                var state = 1;
        ...
        (function (UTF8) {
            ...
            UTF8.encode = function (str) {
                if (!str || str.length == 0)
                    return new Uint8Array(0);
                if (LZUTF8_LIGHT.runningInNodeJS()) {
                    return LZUTF8_LIGHT.BufferTools.bufferToUint8Array(Buffer.from(str, "utf8"));
                }
            ...
            UTF8.decode = function (utf8Bytes) {
                if (!utf8Bytes || utf8Bytes.length == 0)
                    return "";
                if (LZUTF8_LIGHT.runningInNodeJS()) {
                    return LZUTF8_LIGHT.BufferTools.uint8ArrayToBuffer(utf8Bytes).toString("utf8");
                }
                else if (UTF8.createNativeTextEncoderAndDecoderIfAvailable()) {
...
(function (LZUTF8_LIGHT) {
    function compress(input, options) {
        ...
        var inputEncoding = LZUTF8_LIGHT.CompressionCommon.detectCompressionSourceEncoding(input);
        options = LZUTF8_LIGHT.ObjectTools.override({ inputEncoding: inputEncoding, outputEncoding: "ByteArray" }, options);
        var compressor = new LZUTF8_LIGHT.Compressor();
        var compressedBytes = compressor.compressBlock(input);
        return LZUTF8_LIGHT.CompressionCommon.encodeCompressedBytes(compressedBytes, options.outputEncoding);
    }
    LZUTF8_LIGHT.compress = compress;
    function decompress(input, options) {
        if (options === void 0) { options = {}; }
        if (input == null)
            throw new TypeError("decompress: undefined or null input received");
        options = LZUTF8_LIGHT.ObjectTools.override({ inputEncoding: "ByteArray", outputEncoding: "String" }, options);
        var inputBytes = LZUTF8_LIGHT.CompressionCommon.decodeCompressedBytes(input, options.inputEncoding);
        var decompressor = new LZUTF8_LIGHT.Decompressor();
        var decompressedBytes = decompressor.decompressBlock(inputBytes);
        return LZUTF8_LIGHT.CompressionCommon.encodeDecompressedBytes(decompressedBytes, options.outputEncoding);
    }
    LZUTF8_LIGHT.decompress = decompress;
    function encodeUTF8(str) {
        return LZUTF8_LIGHT.Encoding.UTF8.encode(str);
    }
    LZUTF8_LIGHT.encodeUTF8 = encodeUTF8;
    function decodeUTF8(input) {
        return LZUTF8_LIGHT.Encoding.UTF8.decode(input);
    }
    LZUTF8_LIGHT.decodeUTF8 = decodeUTF8;
    function encodeBase64(input) {
        return LZUTF8_LIGHT.Encoding.Base64.encode(input);
    }
    LZUTF8_LIGHT.encodeBase64 = encodeBase64;
    function decodeBase64(str) {
        return LZUTF8_LIGHT.Encoding.Base64.decode(str);
    }
    LZUTF8_LIGHT.decodeBase64 = decodeBase64;
    function encodeBinaryString(input) {
        return LZUTF8_LIGHT.Encoding.BinaryString.encode(input);
    }
    LZUTF8_LIGHT.encodeBinaryString = encodeBinaryString;
    function decodeBinaryString(str) {
        return LZUTF8_LIGHT.Encoding.BinaryString.decode(str);
    }
    LZUTF8_LIGHT.decodeBinaryString = decodeBinaryString;
    function encodeStorageBinaryString(input) {
        return LZUTF8_LIGHT.Encoding.StorageBinaryString.encode(input);
    }
    LZUTF8_LIGHT.encodeStorageBinaryString = encodeStorageBinaryString;
    function decodeStorageBinaryString(str) {
        return LZUTF8_LIGHT.Encoding.StorageBinaryString.decode(str);
    }
    LZUTF8_LIGHT.decodeStorageBinaryString = decodeStorageBinaryString;
})(LZUTF8_LIGHT || (LZUTF8_LIGHT = {}));
